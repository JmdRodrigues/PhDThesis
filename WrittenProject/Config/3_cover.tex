...
%                           [m] for male
%         You may use "\\" to force line breaks
\ntaddperson{committee}(c,m){José Paulo Santos, Full Professor, FCT-NOVA University Lisbon}
\ntaddperson{committee}(r,m){Jaime dos Santos Cardoso, Full Professor, Engineering Faculty of Porto}
...
\ntaddperson{committee}(m,f){João Manuel Rendeiro Cardoso, Auxiliar Professor, Physics Department, University of Coimbra}
