...
%         You may use "\\" to force line breaks
\nttitle(sub,en){The Linguistic nature of Time Series}%
\nttitle(sub,pt){A natureza linguística das séries temporais}%
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,f){Hugo Filipe Silveira Gamboa, Associate Professor, FCT NOVA University Lisbon}
% Co-advisers(s)
