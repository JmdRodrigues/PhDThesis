...
\multirow{4}{1em}{S4} & \multirow{4}{6em}{A 0.5 D1 thr} & (0p)+(0z)*(0n)+ & \textcolor{mygreen2}{bottomPeak} & \multirow{4}{9em}{\includegraphics[height=10ex, valign=m]{example_overall_queries_4.pdf}}\\
 ...
 \hline
\multirow{4}{1em}{S5} & \multirow{4}{6em}{D2 thr D1 thr} & (Dp)+ & \textcolor{mygreen2}{concaveRising} & \multirow{4}{9em}{\includegraphics[height=10ex, valign=m]{abp_overall_concave.pdf}}\\
...
\hline
\textbf{\textit{Shape}} & The normalized \gls{ed} profile of the time series with a \textcolor{myorange2}{query} given by the user as an example. A word must be given as well and integrated into the query language. & \includegraphics[height=10ex, valign=m]{thumbnail_shape.pdf}\\
\bottomrule[1.5pt]
\end{tabular}
\label{tab:quots_wfv}
\end{center}
