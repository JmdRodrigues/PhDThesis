...
\begin{itemize}
  ...
  \item \textbf{Recurrent pattern}: Re-occurrences of similar \textit{subsequences} with specific patterns should be of interest. Unlike \textit{periodicity}, \textit{recurrent} patterns do not have a temporal regularity, e.g., the \textcolor{myblue}{arrhythmias} found in an \gls{ecg} signal like \includegraphics[height=3ex, valign=m]{arrhytmia_thumbnail.pdf}.
